...
<a href="https://cdn.jsdelivr.net/gh/mx3618/Indxr-landing@main/media/demo-index-under-1min.mp4"><img src="media/demo-poster.png" alt="Watch the demo — indexing a 440K-line codebase in under a minute" width="640"></a>

<video controls width="640" src="https://cdn.jsdelivr.net/gh/mx3618/Indxr-landing@main/media/demo-index-under-1min.mp4"></video>
*Full structural index of the codebase, completed in under a minute. Click the thumbnail to play — or [open the video](https://cdn.jsdelivr.net/gh/mx3618/Indxr-landing@main/media/demo-index-under-1min.mp4) in a new tab.*
